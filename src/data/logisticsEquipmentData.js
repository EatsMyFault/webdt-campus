...
const TRUCK_CONFIGS = [
  {
    ...
    shipmentOrder: "SO-260911-01", cargo: "SHAFT-A17", quantity: 240, handled: 173,
    loadProgress: 72, dockId: "DOCK-LG-01", dockLabel: "1번 출하 도크",
    origin: "생산 A동 완성품 구역", destination: "광주 완성품 창고",
  ...
  },
  {
    ...
    shipmentOrder: "SO-260911-02", cargo: "GEARBOX-X1", quantity: 180, handled: 0,
    loadProgress: 0, dockId: "DOCK-LG-03", dockLabel: "3번 출하 도크",
    origin: "생산 B동 출하 대기 구역", destination: "대전 조립 공장",
  ...
  },
  {
    ...
    shipmentOrder: "SO-260911-03", cargo: "ACTUATOR-Z4", quantity: 320, handled: 138,
    loadProgress: 43, dockId: "DOCK-LG-05", dockLabel: "5번 출하 도크",
    origin: "생산 B동 최종검사 구역", destination: "부산 수출 물류센터",
  ...
  },
  {
    ...
    shipmentOrder: "IN-260911-04", cargo: "베어링 조립 키트", quantity: 96, handled: 96,
    loadProgress: 100, dockId: "DOCK-LG-07", dockLabel: "7번 입출고 도크",
    origin: "협력사 자재센터", destination: "물류센터 입고 구역",
...
export const LOGISTICS_TRUCKS = TRUCK_CONFIGS.map((truck) => createCommon({
  ...
  location: `물류·출하 센터 · ${truck.dockLabel}`,
  description: "완성품 출하 또는 생산 자재 입고를 담당하는 물류 운송 차량입니다.",
  metrics: [
...
const DOCK_CONFIGS = [
  { number: 1, status: "running", stage: "loading", stageLabel: "상차 중", truckId: "TRUCK-LG-01", vehicleNumber: "85아 4107", order: "SO-260911-01", cargo: "SHAFT-A17", quantity: 240, handled: 173, progress: 72, queue: 0, throughput: 18 },
  ...
  { number: 3, status: "idle", stage: "reserved", stageLabel: "차량 진입 대기", truckId: "TRUCK-LG-02", vehicleNumber: "91바 2384", order: "SO-260911-02", cargo: "GEARBOX-X1", quantity: 180, handled: 0, progress: 0, queue: 1, throughput: 15 },
  { number: 4, status: "running", stage: "loading", stageLabel: "상차 중", truckId: null, vehicleNumber: "협력사 차량", order: "SO-260911-04", cargo: "SLEEVE-C12", quantity: 210, handled: 126, progress: 60, queue: 0, throughput: 20 },
  { number: 5, status: "warning", stage: "inspection", stageLabel: "출하검사 보류", truckId: "TRUCK-LG-03", vehicleNumber: "83자 7712", order: "SO-260911-03", cargo: "ACTUATOR-Z4", quantity: 320, handled: 138, progress: 43, queue: 0, throughput: 9 },
  ...
  { number: 7, status: "running", stage: "unloading", stageLabel: "입고 하차 중", truckId: "TRUCK-LG-04", vehicleNumber: "89사 5529", order: "IN-260911-04", cargo: "베어링 조립 키트", quantity: 96, handled: 96, progress: 100, queue: 1, throughput: 11 },
];
...
export const LOGISTICS_DOCKS = DOCK_CONFIGS.map((dock) => {
  ...
  return createCommon({
    ...
    status: dock.status,
    temperature,
    location: `물류·출하 센터 · 전면 도크 ${dock.number}`,
    description: "트럭 도킹, 셔터 제어와 제품 상하차 작업을 관리하는 출하 도크입니다.",
    metrics: [
